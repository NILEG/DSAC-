...
int main()
{
	...
	//cout<<"Depth of 2 is: "<<specific_depth(2, root, 0)<<endl;
	//del(40);
	//inorder(root);
	//pre_order(root);
	//post_order(root);
	...
	//inorder_predecessor(13);
	//preorder_successor(24);
	//preorder_predecessor(26);
	//postorder_successor(4);
	//postorder_predecessor(19);
	//display_having_two_childs(root);
	//display_having_one_child(root);
	//position_with_parent(5);
